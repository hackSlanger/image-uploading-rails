...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { image: @hotel.image, location: @hotel.location, name: @hotel.name, review: @hotel.review } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { image: @hotel.image, location: @hotel.location, name: @hotel.name, review: @hotel.review } }
